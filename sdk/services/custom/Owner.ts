...
/**
 * Api services for the `Owner` model.
 */
@Injectable()
export class OwnerApi extends BaseLoopBackApi {
  ...
  /**
   * Buscar un elemento relacionado por id para cars.
   *
   * @param {any} id Owner id
   *
   * @param {any} fk Clave foránea para cars
   *
  ...
  /**
   * Suprimir un elemento relacionado por id para cars.
   *
   * @param {any} id Owner id
   *
   * @param {any} fk Clave foránea para cars
  ...
  /**
   * Actualizar un elemento relacionado por id para cars.
   *
   * @param {any} id Owner id
   *
   * @param {any} fk Clave foránea para cars
  ...
  /**
   * Crea una nueva instancia en cars de este modelo.
   *
   * @param {any} id Owner id
   *
   * @param {object} data Request data.
  ...
  /**
   * Suprime todos los cars de este modelo.
   *
   * @param {any} id Owner id
   *
   * @returns {object} An empty reference that will be
